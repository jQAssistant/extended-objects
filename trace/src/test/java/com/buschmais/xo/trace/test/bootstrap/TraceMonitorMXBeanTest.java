package com.buschmais.xo.trace.test.bootstrap;
...
import com.buschmais.xo.trace.test.bootstrap.composite.A;
...
/**
 * Verifies the functionality of {@link com.buschmais.xo.trace.impl.TraceMonitorMXBean}.
 */
public class TraceMonitorMXBeanTest {
    ...
    public void methodStatistics() throws URISyntaxException, IOException, JMException {
        XOUnit xoUnit = XOUnitBuilder.create("file:target/json/store", TraceDatastoreProvider.class, A.class).property("com.buschmais.xo.trace.api.DelegateProvider", JsonFileStoreProvider.class.getName()).create();

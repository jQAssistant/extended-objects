[[naming:Default]]
[role=group,includesConstraints="naming:TypeNameMustBeginWithGroupId,naming:TypeNameMustContainArtifactId,naming:AbstractClassNamePrefix,naming:NonAbstractClassNamePrefix"]
== Naming Rules

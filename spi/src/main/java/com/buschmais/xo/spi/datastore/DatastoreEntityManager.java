 ...
 */
public interface DatastoreEntityManager<EntityId, Entity, EntityMetadata extends DatastoreEntityMetadata<EntityDiscriminator>, EntityDiscriminator, PrimitivePropertyMeta>
        extends DatastorePropertyManager<Entity, PrimitivePropertyMeta> {
    ...
    /**
     * Find entities using a single primitive value (e.g. from an index if
     ...
     * @param value
     *            The primitive value (e.g. indexed value).

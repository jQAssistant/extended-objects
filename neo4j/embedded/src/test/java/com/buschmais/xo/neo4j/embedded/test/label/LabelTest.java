package com.buschmais.xo.neo4j.embedded.test.label;
...
import com.buschmais.xo.neo4j.embedded.test.label.composite.ExplicitLabel;
import com.buschmais.xo.neo4j.embedded.test.label.composite.ImplicitLabel;

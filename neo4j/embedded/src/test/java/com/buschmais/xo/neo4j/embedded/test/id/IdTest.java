package com.buschmais.xo.neo4j.embedded.test.id;
...
import com.buschmais.xo.neo4j.embedded.test.id.composite.A;
import com.buschmais.xo.neo4j.embedded.test.id.composite.A2B;
import com.buschmais.xo.neo4j.embedded.test.id.composite.B;

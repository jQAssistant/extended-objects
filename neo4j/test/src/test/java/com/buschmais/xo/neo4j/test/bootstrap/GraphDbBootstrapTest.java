...
public class GraphDbBootstrapTest {
    ...
    public void bootstrap() throws URISyntaxException {
        ...
        XOUnit xoUnit = XOUnitBuilder.create("graphDb:///", EmbeddedNeo4jXOProvider.class, A.class).property(GraphDatabaseService.class.getName(), graphDatabaseService).create();

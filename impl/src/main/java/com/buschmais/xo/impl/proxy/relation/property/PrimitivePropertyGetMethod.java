...
public class PrimitivePropertyGetMethod<Entity, Relation>
    extends AbstractPrimitivePropertyGetMethod<Entity, Relation, Relation, RelationPropertyManager<Entity, Relation>> {

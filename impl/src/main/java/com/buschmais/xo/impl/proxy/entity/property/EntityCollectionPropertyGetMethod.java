 ...
 *            The relation type.
 */
public class EntityCollectionPropertyGetMethod<Entity, Relation> extends
        AbstractCollectionPropertyGetMethod<Entity, Entity, Relation, EntityPropertyManager<Entity, Relation, ?>, EntityCollectionPropertyMethodMetadata<?>> {
     ...
     *            The metadata.
     */
    public EntityCollectionPropertyGetMethod(SessionContext<?, Entity, ?, ?, ?, Relation, ?, ?, ?> sessionContext,
